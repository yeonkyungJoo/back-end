...
public class CreateProjectRequest extends ProjectRequest {
    ...
    @Builder
    public CreateProjectRequest(@NotEmpty String projectName, @NotEmpty String startDate, String endDate, @NotEmpty String shortDescription, Set<String> tags, String description, String url, boolean open) {
